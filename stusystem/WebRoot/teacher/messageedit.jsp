	...
	<div class="formbody">
		...
		<ul class="forminfo">
			<form id="frmlogin" name="frmlogin" method="post"
				action="domessage?op=doedit"">
				<input type="hidden" name="messageid" value="${message.id }"/>
				
				<li><label>标题名称</label><input id="title" name="title"
					type="text" class="dfinput" value="${message.title }"/><i>请输入信息标题</i></li>
				
				<li><label>信息内容</label>
				<textarea id="context" name="context" rows="20" cols="10">${message.content}</textarea></li>
