...
<body>
    ...
    <table class="tablelist">
        ...
        <td><a href="doclass?op=slist&pid=${c.profession.pro_id}&id=${c.class_id}&tid=${c.teacher.teacher_id}" class="tablelink">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="doclass?op=toedit1&pid=${c.profession.pro_id}&id=${c.class_id}&tid=${c.teacher.teacher_id}" class="tablelink">修改</a>&nbsp;&nbsp; &nbsp;&nbsp;
            <a href="doclass?op=dodel&pid=${c.profession.pro_id}&id=${c.class_id}&tid=${c.teacher.teacher_id}" class="tablelink" onclick="return isdel();">删除</a></td>
        </tr> 
        </c:forEach>
        </tbody>
    </table>
